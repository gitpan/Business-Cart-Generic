package Business::Cart::Generic::Schema::Result::CustomerType;
...
__PACKAGE__->table("customer_types");
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'customer_types_id_seq'
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:RrK3+Nf8MGKeZ069Bi7Kag
